...
export const metadata = { title: 'Superadmin Dashboard — Lazapee' };
    ...
    return (
        <div className="space-y-10 max-w-6xl">
            ...
            <div className="flex items-center gap-4 pb-6 border-b border-gray-100">
                ...
                <div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Superadmin Dashboard</h1>
                    <p className="text-sm text-gray-500 mt-1 font-medium">Ultimate platform overview and management</p>
                </div>
            </div>
